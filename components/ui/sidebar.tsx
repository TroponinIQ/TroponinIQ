...
// Safe wrapper for internal components that handles missing context during sign-out
...
>(
  (
    ...
    // Effect to sync initial state from cookie after hydration
    React.useEffect(() => {
      // Small delay to ensure DOM is ready and cookies are accessible
      const timer = setTimeout(() => {
        ...
        if (cookieValue !== undefined) {
          ...
          // For first-time users, ensure the state matches defaultOpen
          _setOpen(defaultOpen);
        }
      }, 0);

      return () => clearTimeout(timer);
    }, [defaultOpen]);  // Include defaultOpen in dependencies to handle prop changes
